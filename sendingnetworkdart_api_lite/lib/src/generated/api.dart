...
import '../model/key/client_public_key.dart';
import '../model/children_state.dart';
import '../model/sdn_event.dart';
import '../model/sdn_keys.dart';
...
class Api {
  ...
  Future<bool> registrationTokenValidity(String token) async {
    final requestUri = Uri(
        path: '_api/client/v1/register/m.login.registration_token/validity',
        queryParameters: {
          'token': token,
        });
    final request = Request('GET', baseUri!.resolveUri(requestUri));
  ...
  Future<GetSpaceHierarchyResponse> getSpaceHierarchy(String roomId,
    ...
    final requestUri = Uri(
        path: '_api/client/v1/rooms/${Uri.encodeComponent(roomId)}/hierarchy',
        queryParameters: {
  ...
  /// `start` token from [`/messages`](https://spec.sdn.org/unstable/client-server-api/#get_sdnclientv3roomsroomidmessages),
  /// or a `next_batch` token from [`/sync`](https://spec.sdn.org/unstable/client-server-api/#get_sdnclientv3sync).
  ///
  ...
  Future<GetRelatingEventsResponse> getRelatingEvents(
    ...
    final requestUri = Uri(
        path:
            '_api/client/v1/rooms/${Uri.encodeComponent(roomId)}/relations/${Uri.encodeComponent(eventId)}',
        queryParameters: {
          if (from != null) 'from': from,
          if (to != null) 'to': to,
          if (limit != null) 'limit': limit.toString(),
  ...
  /// [eventId] The ID of the parent event whose child events are to be returned.
  ///
  /// [relType] The [relationship type](https://spec.sdn.org/unstable/client-server-api/#relationship-types) to search for.
  ///
  /// [from] The pagination token to start returning results from. If not supplied, results
  /// start at the most recent topological event known to the server.
  ///
  ...
  Future<GetRelatingEventsWithRelTypeResponse> getRelatingEventsWithRelType(
    ...
    final requestUri = Uri(
        path:
            '_api/client/v1/rooms/${Uri.encodeComponent(roomId)}/relations/${Uri.encodeComponent(eventId)}/${Uri.encodeComponent(relType)}',
        queryParameters: {
          if (from != null) 'from': from,
          if (to != null) 'to': to,
          if (limit != null) 'limit': limit.toString(),
  ...
  Future<GetRelatingEventsWithRelTypeAndEventTypeResponse>
    ...
    final requestUri = Uri(
        path:
            '_api/client/v1/rooms/${Uri.encodeComponent(roomId)}/relations/${Uri.encodeComponent(eventId)}/${Uri.encodeComponent(relType)}/${Uri.encodeComponent(eventType)}',
        queryParameters: {
          if (from != null) 'from': from,
          if (to != null) 'to': to,
          if (limit != null) 'limit': limit.toString(),
  ...
  /// thread roots for threads the user has [participated in](https://spec.sdn.org/unstable/client-server-api/#server-side-aggregation-of-mthread-relationships)
  /// will be returned.
  ///
  ...
  /// corresponding [federation endpoint](https://spec.sdn.org/unstable/server-server-api/#get_sdnfederationv1timestamp_to_eventroomid)
  /// to ask other servers for a suitable event.
  ///
  /// After calling this endpoint, clients can call
  /// [`/rooms/{roomId}/context/{eventId}`](#get_sdnclientv3roomsroomidcontexteventid)
  ...
  Future<GetEventByTimestampResponse> getEventByTimestamp(
    ...
    final requestUri = Uri(
        path:
            '_api/client/v1/rooms/${Uri.encodeComponent(roomId)}/timestamp_to_event',
        queryParameters: {
          'ts': ts.toString(),
          'dir': dir.name,
        });
  ...
  /// the user's SDN ID in identity servers.
  ///
  ...
  /// for an access token). The node must send this token to the
  /// user (if applicable), who should then be prompted to provide it
  /// to the client.
  ///
  /// If this field is not present, the client can assume that
  /// verification will happen without the client's involvement
  /// provided the node advertises this specification version
  ...
  /// This API endpoint uses the [User-Interactive Authentication API](https://spec.sdn.org/unstable/client-server-api/#user-interactive-authentication-api).
  ///
  ...
  ///
  /// [clientSecret] The client secret used in the session with the node.
  ///
  /// [sid] The session identifier given by the node.
  Future<void> add3PID(String clientSecret, String sid,
      {AuthenticationData? auth}) async {
    final requestUri = Uri(path: '_api/client/v3/account/3pid/add');
    final request = Request('POST', baseUri!.resolveUri(requestUri));
    request.headers['authorization'] = 'Bearer ${bearerToken!}';
    request.headers['content-type'] = 'application/json';
    request.bodyBytes = utf8.encode(jsonEncode({
  ...
  ///
  /// [idServer] The identity server to unbind from. If not provided, the node
  ...
  Future<IdServerUnbindResult> delete3pidFromAccount(
    ...
    final requestUri = Uri(path: '_api/client/v3/account/3pid/delete');
    final request = Request('POST', baseUri!.resolveUri(requestUri));
    request.headers['authorization'] = 'Bearer ${bearerToken!}';
    request.headers['content-type'] = 'application/json';
    request.bodyBytes = utf8.encode(jsonEncode({
  ...
  /// the [`/register/email/requestToken`](https://spec.sdn.org/unstable/client-server-api/#post_sdnclientv3registeremailrequesttoken)
  /// endpoint. The node should validate
  ...
  Future<RequestTokenResponse> requestTokenTo3PIDEmail(
    ...
    final requestUri =
        Uri(path: '_api/client/v3/account/3pid/email/requestToken');
    final request = Request('POST', baseUri!.resolveUri(requestUri));
    request.headers['content-type'] = 'application/json';
    request.bodyBytes = utf8.encode(jsonEncode({
      'client_secret': clientSecret,
  ...
  /// account. This API's parameters and response are identical to that of
  /// the [`/register/msisdn/requestToken`](https://spec.sdn.org/unstable/client-server-api/#post_sdnclientv3registermsisdnrequesttoken)
  /// endpoint. The node should validate
  ...
  Future<RequestTokenResponse> requestTokenTo3PIDMSISDN(
      ...
      {String? nextLink, String? idAccessToken, String? idServer}) async {
    final requestUri =
        Uri(path: '_api/client/v3/account/3pid/msisdn/requestToken');
    final request = Request('POST', baseUri!.resolveUri(requestUri));
    request.headers['content-type'] = 'application/json';
    request.bodyBytes = utf8.encode(jsonEncode({
      'client_secret': clientSecret,
  ...
  Future<IdServerUnbindResult> unbind3pidFromAccount(
      String address, ThirdPartyIdentifierMedium medium,
      {String? idServer}) async {
    final requestUri = Uri(path: '_api/client/v3/account/3pid/unbind');
    final request = Request('POST', baseUri!.resolveUri(requestUri));
    request.headers['authorization'] = 'Bearer ${bearerToken!}';
    request.headers['content-type'] = 'application/json';
    request.bodyBytes = utf8.encode(jsonEncode({
  ...
  ///
  /// This API endpoint uses the [User-Interactive Authentication API](https://spec.sdn.org/unstable/client-server-api/#user-interactive-authentication-api) to
  ...
  ///
  /// When `false`, the server can still take advantage of the [soft logout method](https://spec.sdn.org/unstable/client-server-api/#soft-logout)
  ...
  /// [`/register/email/requestToken`](https://spec.sdn.org/unstable/client-server-api/#post_sdnclientv3registeremailrequesttoken)
  ...
  ///
  /// This API's parameters and response are identical to that of the
  /// [`/register/msisdn/requestToken`](https://spec.sdn.org/unstable/client-server-api/#post_sdnclientv3registermsisdnrequesttoken)
  /// endpoint, except that
  /// `M_THREEPID_NOT_FOUND` may be returned if no account matching the
  ...
  Future<Capabilities> getCapabilities() async {
    final requestUri = Uri(path: '_api/client/v3/capabilities');
    final request = Request('GET', baseUri!.resolveUri(requestUri));
    request.headers['authorization'] = 'Bearer ${bearerToken!}';
    final response = await httpClient.send(request);
    final responseBody = await response.stream.toBytes();
  ...
  /// of the [`m.room.create`](https://spec.sdn.org/unstable/client-server-api/#mroomcreate) event. The server will overwrite the following
  ...
  /// `invite_3pid`. See [Direct Messaging](https://spec.sdn.org/unstable/client-server-api/#direct-messaging) for more information.
  ///
  ...
  /// [`m.room.power_levels`](https://spec.sdn.org/unstable/client-server-api/#mroompower_levels)
  ...
  /// into the room.
  ///
  /// [roomVersion] The room version to set for the room. If not provided, the node is
  ...
  Future<String> createRoom(
    ...
    final requestUri = Uri(path: '_api/client/v3/createRoom');
    final request = Request('POST', baseUri!.resolveUri(requestUri));
    request.headers['authorization'] = 'Bearer ${bearerToken!}';
    request.headers['content-type'] = 'application/json';
    request.bodyBytes = utf8.encode(jsonEncode({
  ...
  Future<void> deleteDevices(List<String> devices,
      {AuthenticationData? auth}) async {
    final requestUri = Uri(path: '_api/client/v3/delete_devices');
    final request = Request('POST', baseUri!.resolveUri(requestUri));
    request.headers['authorization'] = 'Bearer ${bearerToken!}';
    request.headers['content-type'] = 'application/json';
    request.bodyBytes = utf8.encode(jsonEncode({
  ...
  Future<List<Device>?> getDevices() async {
    final requestUri = Uri(path: '_api/client/v3/devices');
    final request = Request('GET', baseUri!.resolveUri(requestUri));
    request.headers['authorization'] = 'Bearer ${bearerToken!}';
    final response = await httpClient.send(request);
    final responseBody = await response.stream.toBytes();
  ...
  Future<Map<String, Object?>> updateAppserviceRoomDirectoryVisibility(
    ...
    final requestUri = Uri(
        path:
            '_api/client/v3/directory/list/appservice/${Uri.encodeComponent(networkId)}/${Uri.encodeComponent(roomId)}');
    final request = Request('PUT', baseUri!.resolveUri(requestUri));
    request.headers['authorization'] = 'Bearer ${bearerToken!}';
    request.headers['content-type'] = 'application/json';
    request.bodyBytes = utf8.encode(jsonEncode({
  ...
  Future<Visibility?> getRoomVisibilityOnDirectory(String roomId) async {
    final requestUri = Uri(
        path:
            '_api/client/v3/directory/list/room/${Uri.encodeComponent(roomId)}');
    final request = Request('GET', baseUri!.resolveUri(requestUri));
    final response = await httpClient.send(request);
    final responseBody = await response.stream.toBytes();
    if (response.statusCode != 200) unexpectedResponse(response, responseBody);
  ...
  /// [in the appendices](https://spec.sdn.org/unstable/appendices/#room-aliases).
  ///
  ...
  /// should instead call the [`/sync`](https://spec.sdn.org/unstable/client-server-api/#get_sdnclientv3sync)
  /// endpoint with a `since` parameter. See
  /// the [migration guide](https://sdn.org/docs/guides/migrating-from-client-server-api-v-1#deprecated-endpoints).
  ///
  ...
  /// [/rooms/{roomId}/event/{eventId}](https://spec.sdn.org/unstable/client-server-api/#get_sdnclientv3roomsroomideventeventid) API
  /// or the [/rooms/{roomId}/context/{eventId](https://spec.sdn.org/unstable/client-server-api/#get_sdnclientv3roomsroomidcontexteventid) API.
  ///
  /// [eventId] The event ID to get.
  @deprecated
  Future<SDNEvent> getOneEvent(String eventId) async {
    final requestUri =
        Uri(path: '_api/client/v3/events/${Uri.encodeComponent(eventId)}');
    final request = Request('GET', baseUri!.resolveUri(requestUri));
    request.headers['authorization'] = 'Bearer ${bearerToken!}';
    final response = await httpClient.send(request);
    final responseBody = await response.stream.toBytes();
    ...
    final responseString = utf8.decode(responseBody);
    final json = jsonDecode(responseString);
    return SDNEvent.fromJson(json as Map<String, Object?>);
  }
  ...
  /// response of the [`/initialSync`](https://spec.sdn.org/unstable/client-server-api/#get_sdnclientv3initialsync)
  /// and [`/sync`](https://spec.sdn.org/unstable/client-server-api/#get_sdnclientv3sync) APIs.
  ///
  ...
  /// membership event.
  ///
  /// [thirdPartySigned] If a `third_party_signed` was supplied, the node must verify
  ...
  Future<String> joinRoom(String roomIdOrAlias,
    ...
    final requestUri = Uri(
        path: '_api/client/v3/join/${Uri.encodeComponent(roomIdOrAlias)}',
        queryParameters: {
          if (serverName != null)
  ...
  Future<List<String>> getJoinedRooms() async {
    final requestUri = Uri(path: '_api/client/v3/joined_rooms');
    final request = Request('GET', baseUri!.resolveUri(requestUri));
    request.headers['authorization'] = 'Bearer ${bearerToken!}';
    final response = await httpClient.send(request);
    final responseBody = await response.stream.toBytes();
  ...
  /// from a response to an earlier call to [`/sync`](https://spec.sdn.org/unstable/client-server-api/#get_sdnclientv3sync). Users who have not
  /// uploaded new device identity keys since this point, nor deleted
  /// existing devices with identity keys since then, will be excluded
  /// from the results.
  ///
  /// [to] The desired end point of the list. Should be the `next_batch`
  /// field from a recent call to [`/sync`](https://spec.sdn.org/unstable/client-server-api/#get_sdnclientv3sync) - typically the most recent
  /// such call. This may be used by the server as a hint to check its
  /// caches are up to date.
  Future<GetKeysChangesResponse> getKeysChanges(String from, String to) async {
    final requestUri =
        Uri(path: '_api/client/v3/keys/changes', queryParameters: {
      'from': from,
      'to': to,
    });
    final request = Request('GET', baseUri!.resolveUri(requestUri));
    request.headers['authorization'] = 'Bearer ${bearerToken!}';
    print("request:${baseUri!.resolveUri(requestUri)}");
  ...
  Future<ClaimKeysResponse> claimKeys(
      ...
      {int? timeout}) async {
    final requestUri = Uri(path: '_api/client/v3/keys/claim');
    final request = Request('POST', baseUri!.resolveUri(requestUri));
    request.headers['authorization'] = 'Bearer ${bearerToken!}';
    request.headers['content-type'] = 'application/json';
    request.bodyBytes = utf8.encode(jsonEncode({
  ...
  Future<void> uploadCrossSigningKeys(
      ...
      SDNCrossSigningKey? userSigningKey}) async {
    final requestUri = Uri(path: '_api/client/v3/keys/device_signing/upload');
    final request = Request('POST', baseUri!.resolveUri(requestUri));
    request.headers['authorization'] = 'Bearer ${bearerToken!}';
    request.headers['content-type'] = 'application/json';
    request.bodyBytes = utf8.encode(jsonEncode({
  ...
  Future<QueryKeysResponse> queryKeys(Map<String, List<String>> deviceKeys,
    ...
    final requestUri = Uri(path: '_api/client/v3/keys/query');
    final request = Request('POST', baseUri!.resolveUri(requestUri));
    request.headers['authorization'] = 'Bearer ${bearerToken!}';
    request.headers['content-type'] = 'application/json';
    request.bodyBytes = utf8.encode(jsonEncode({
  ...
  /// [`/sync`](https://spec.sdn.org/unstable/client-server-api/#get_sdnclientv3sync) API.
  ///
  ...
  /// [Relationship between access tokens and devices](https://spec.sdn.org/unstable/client-server-api/#relationship-between-access-tokens-and-devices).
  ///
  ...
  /// [cross-signing](https://spec.sdn.org/unstable/client-server-api/#cross-signing) key ID.
  ...
  /// for the user are also deleted. [Device keys](https://spec.sdn.org/unstable/client-server-api/#device-keys) for the device are
  /// deleted alongside the device.
  ///
  /// This endpoint does not use the [User-Interactive Authentication API](https://spec.sdn.org/unstable/client-server-api/#user-interactive-authentication-api) because
  ...
  Future<void> logoutAll() async {
    final requestUri = Uri(path: '_api/client/v3/logout/all');
    final request = Request('POST', baseUri!.resolveUri(requestUri));
    request.headers['authorization'] = 'Bearer ${bearerToken!}';
    final response = await httpClient.send(request);
    final responseBody = await response.stream.toBytes();
  ...
  Future<GetNotificationsResponse> getNotifications(
    ...
    final requestUri =
        Uri(path: '_api/client/v3/notifications', queryParameters: {
      if (from != null) 'from': from,
      if (limit != null) 'limit': limit.toString(),
  ...
  Future<GetPresenceResponse> getPresence(String userId) async {
    final requestUri = Uri(
        path: '_api/client/v3/presence/${Uri.encodeComponent(userId)}/status');
    final request = Request('GET', baseUri!.resolveUri(requestUri));
    request.headers['authorization'] = 'Bearer ${bearerToken!}';
    final response = await httpClient.send(request);
    final responseBody = await response.stream.toBytes();
  ...
  Future<Uri?> getAvatarUrl(String userId) async {
    final requestUri = Uri(
        path:
            '_api/client/v3/profile/${Uri.encodeComponent(userId)}/avatar_url');
    final request = Request('GET', baseUri!.resolveUri(requestUri));
    final response = await httpClient.send(request);
    final responseBody = await response.stream.toBytes();
    if (response.statusCode != 200) unexpectedResponse(response, responseBody);
  ...
  Future<void> deletePushRule(
    ...
    final requestUri = Uri(
        path:
            '_api/client/v3/pushrules/${Uri.encodeComponent(scope)}/${Uri.encodeComponent(kind.name)}/${Uri.encodeComponent(ruleId)}');
    final request = Request('DELETE', baseUri!.resolveUri(requestUri));
    request.headers['authorization'] = 'Bearer ${bearerToken!}';
    final response = await httpClient.send(request);
    final responseBody = await response.stream.toBytes();
  ...
  Future<List<Object?>> getPushRuleActions(
    ...
    final requestUri = Uri(
        path:
            '_api/client/v3/pushrules/${Uri.encodeComponent(scope)}/${Uri.encodeComponent(kind.name)}/${Uri.encodeComponent(ruleId)}/actions');
    final request = Request('GET', baseUri!.resolveUri(requestUri));
    request.headers['authorization'] = 'Bearer ${bearerToken!}';
    final response = await httpClient.send(request);
    final responseBody = await response.stream.toBytes();
  ...
  /// This API endpoint uses the [User-Interactive Authentication API](https://spec.sdn.org/unstable/client-server-api/#user-interactive-authentication-api), except in
  ...
  /// [SDN specification](https://spec.sdn.org/unstable/appendices/#user-identifiers).
  ///
  ...
  /// [refreshToken] If true, the client supports refresh tokens.
  ///
  /// [username] The basis for the localpart of the desired SDN ID. If omitted,
  ...
  Future<RegisterResponse> register(
    ...
    final requestUri = Uri(path: '_api/client/v3/register', queryParameters: {
  ...
  Future<bool?> checkUsernameAvailability(String username) async {
    final requestUri =
        Uri(path: '_api/client/v3/register/available', queryParameters: {
      'username': username,
    });
    final request = Request('GET', baseUri!.resolveUri(requestUri));
    final response = await httpClient.send(request);
  ...
  Future<RequestTokenResponse> requestTokenToRegisterEmail(
      String clientSecret, String email, int sendAttempt,
      {String? nextLink, String? idAccessToken, String? idServer}) async {
    final requestUri = Uri(path: '_api/client/v3/register/email/requestToken');
    final request = Request('POST', baseUri!.resolveUri(requestUri));
    request.headers['content-type'] = 'application/json';
    request.bodyBytes = utf8.encode(jsonEncode({
      'client_secret': clientSecret,
  ...
  Future<RequestTokenResponse> requestTokenToRegisterMSISDN(
      String clientSecret, String country, String phoneNumber, int sendAttempt,
      {String? nextLink, String? idAccessToken, String? idServer}) async {
    final requestUri = Uri(path: '_api/client/v3/register/msisdn/requestToken');
    final request = Request('POST', baseUri!.resolveUri(requestUri));
    request.headers['content-type'] = 'application/json';
    request.bodyBytes = utf8.encode(jsonEncode({
      'client_secret': clientSecret,
  ...
  Future<RoomKeysUpdateResponse> deleteRoomKeys(String version) async {
    final requestUri =
        Uri(path: '_api/client/v3/room_keys/keys', queryParameters: {
      'version': version,
    });
    final request = Request('DELETE', baseUri!.resolveUri(requestUri));
    request.headers['authorization'] = 'Bearer ${bearerToken!}';
  ...
  /// algorithms in [Server-side key backups](https://spec.sdn.org/unstable/client-server-api/#server-side-key-backups) for more information on the
  ...
  /// [`POST /_api/client/v3/room_keys/version`](https://spec.sdn.org/unstable/client-server-api/#post_sdnclientv3room_keysversion)
  /// or [`GET /_api/client/v3/room_keys/version/{version}`](https://spec.sdn.org/unstable/client-server-api/#get_sdnclientv3room_keysversionversion).
  ...
  Future<List<String>> getLocalAliases(String roomId) async {
    final requestUri = Uri(
        path: '_api/client/v3/rooms/${Uri.encodeComponent(roomId)}/aliases');
    final request = Request('GET', baseUri!.resolveUri(requestUri));
    request.headers['authorization'] = 'Bearer ${bearerToken!}';
    final response = await httpClient.send(request);
    final responseBody = await response.stream.toBytes();
  ...
  ///
  /// [reason] The reason the user has been banned. This will be supplied as the `reason` on the target's updated [`m.room.member`](https://spec.sdn.org/unstable/client-server-api/#mroommember) event.
  ///
  ...
  Future<void> ban(String roomId, String userId, {String? reason}) async {
    final requestUri =
        Uri(path: '_api/client/v3/rooms/${Uri.encodeComponent(roomId)}/ban');
    final request = Request('POST', baseUri!.resolveUri(requestUri));
    request.headers['authorization'] = 'Bearer ${bearerToken!}';
    request.headers['content-type'] = 'application/json';
    request.bodyBytes = utf8.encode(jsonEncode({
  ...
  /// [Lazy-loading room members](https://spec.sdn.org/unstable/client-server-api/#lazy-loading-room-members) for more information.
  ///
  ...
  /// node prefers.
  ///
  /// See [Filtering](https://spec.sdn.org/unstable/client-server-api/#filtering) for more information.
  Future<EventContext> getEventContext(String roomId, String eventId,
      {int? limit, String? filter}) async {
    final requestUri = Uri(
        path:
            '_api/client/v3/rooms/${Uri.encodeComponent(roomId)}/context/${Uri.encodeComponent(eventId)}',
        queryParameters: {
          if (limit != null) 'limit': limit.toString(),
  ...
  ///
  /// [eventId] The event ID to get.
  Future<SDNEvent> getOneRoomEvent(String roomId, String eventId) async {
    final requestUri = Uri(
        path:
            '_api/client/v3/rooms/${Uri.encodeComponent(roomId)}/event/${Uri.encodeComponent(eventId)}');
    final request = Request('GET', baseUri!.resolveUri(requestUri));
    request.headers['authorization'] = 'Bearer ${bearerToken!}';
    final response = await httpClient.send(request);
    final responseBody = await response.stream.toBytes();
  ...
  /// [joining rooms section](https://spec.sdn.org/unstable/client-server-api/#post_sdnclientv3roomsroomidinvite).
  ///
  ...
  /// `email` (see [the list of recognised values](https://spec.sdn.org/unstable/appendices/#3pid-types)).
  ...
  /// [third party invites](https://spec.sdn.org/unstable/client-server-api/#third-party-invites) section.*
  ///
  /// This API invites a user to participate in a particular room.
  /// They do not start participating in the room until they actually join the
  /// room.
  ...
  /// membership event.
  ///
  /// [thirdPartySigned] If supplied, the node must verify that it matches a pending
  ...
  Future<String> joinRoomById(String roomId,
    ...
    final requestUri =
        Uri(path: '_api/client/v3/rooms/${Uri.encodeComponent(roomId)}/join');
    final request = Request('POST', baseUri!.resolveUri(requestUri));
    request.headers['authorization'] = 'Bearer ${bearerToken!}';
    request.headers['content-type'] = 'application/json';
    request.bodyBytes = utf8.encode(jsonEncode({
  ...
  Future<Map<String, RoomMember>?> getJoinedMembersByRoom(String roomId) async {
    final requestUri = Uri(
        path:
            '_api/client/v3/rooms/${Uri.encodeComponent(roomId)}/joined_members');
    final request = Request('GET', baseUri!.resolveUri(requestUri));
    request.headers['authorization'] = 'Bearer ${bearerToken!}';
    final response = await httpClient.send(request);
    final responseBody = await response.stream.toBytes();
  ...
  /// `reason` on the target's updated [`m.room.member`](https://spec.sdn.org/unstable/client-server-api/#mroommember) event.
  ///
  ...
  Future<void> kick(String roomId, String userId, {String? reason}) async {
    final requestUri =
        Uri(path: '_api/client/v3/rooms/${Uri.encodeComponent(roomId)}/kick');
    final request = Request('POST', baseUri!.resolveUri(requestUri));
    request.headers['authorization'] = 'Bearer ${bearerToken!}';
    request.headers['content-type'] = 'application/json';
    request.bodyBytes = utf8.encode(jsonEncode({
  ...
  ///
  /// If it is not provided, the node shall return a list of messages
  ...
  Future<GetRoomEventsResponse> getRoomEvents(String roomId, Direction dir,
    ...
    final requestUri = Uri(
        path: '_api/client/v3/rooms/${Uri.encodeComponent(roomId)}/messages',
        queryParameters: {
          if (from != null) 'from': from,
          if (to != null) 'to': to,
          'dir': dir.name,
  ...
  Future<void> setReadMarker(String roomId,
    ...
    final requestUri = Uri(
        path:
            '_api/client/v3/rooms/${Uri.encodeComponent(roomId)}/read_markers');
    final request = Request('POST', baseUri!.resolveUri(requestUri));
    request.headers['authorization'] = 'Bearer ${bearerToken!}';
    request.headers['content-type'] = 'application/json';
    request.bodyBytes = utf8.encode(jsonEncode({
  ...
  /// alternative to [`/read_markers`](https://spec.sdn.org/unstable/client-server-api/#post_sdnclientv3roomsroomidread_markers).
  ///
  ...
  ///
  /// [txnId] The [transaction ID](https://spec.sdn.org/unstable/client-server-api/#transaction-identifiers) for this event. Clients should generate a
  ...
  Future<String?> redactEvent(String roomId, String eventId, String txnId,
    ...
    final requestUri = Uri(
        path:
            '_api/client/v3/rooms/${Uri.encodeComponent(roomId)}/redact/${Uri.encodeComponent(eventId)}/${Uri.encodeComponent(txnId)}');
    final request = Request('PUT', baseUri!.resolveUri(requestUri));
    request.headers['authorization'] = 'Bearer ${bearerToken!}';
    request.headers['content-type'] = 'application/json';
    request.bodyBytes = utf8.encode(jsonEncode({
  ...
  /// [Room Events](https://spec.sdn.org/unstable/client-server-api/#room-events) for the m. event specification.
  ///
  /// [roomId] The room to send the event to.
  ///
  /// [eventType] The type of event to send.
  ///
  /// [txnId] The [transaction ID](https://spec.sdn.org/unstable/client-server-api/#transaction-identifiers) for this event. Clients should generate an
  ...
  Future<String> sendMessage(String roomId, String eventType, String txnId,
    ...
    final requestUri = Uri(
        path:
            '_api/client/v3/rooms/${Uri.encodeComponent(roomId)}/send/${Uri.encodeComponent(eventType)}/${Uri.encodeComponent(txnId)}');
    final request = Request('PUT', baseUri!.resolveUri(requestUri));
    request.headers['authorization'] = 'Bearer ${bearerToken!}';
    request.headers['content-type'] = 'application/json';
  ...
  Future<String> upgradeRoom(String roomId, String newVersion) async {
    final requestUri = Uri(
        path: '_api/client/v3/rooms/${Uri.encodeComponent(roomId)}/upgrade');
    final request = Request('POST', baseUri!.resolveUri(requestUri));
    request.headers['authorization'] = 'Bearer ${bearerToken!}';
    request.headers['content-type'] = 'application/json';
    request.bodyBytes = utf8.encode(jsonEncode({
  ...
  Future<SearchResults> search(Categories searchCategories,
    ...
    final requestUri = Uri(path: '_api/client/v3/search', queryParameters: {
  ...
  ///
  /// *Note*: This endpoint supports lazy-loading. See [Filtering](https://spec.sdn.org/unstable/client-server-api/#filtering)
  ...
  Future<SyncUpdate> sync(
      ...
      int? timeout}) async {
    final requestUri = Uri(path: '_api/client/v3/sync', queryParameters: {
      if (filter != null) 'filter': filter,
      if (since != null) 'since': since,
  ...
  /// alias.
  ///
  /// [alias] The SDN room alias to look up.
  Future<List<Location>> queryLocationByAlias(String alias) async {
    final requestUri =
        Uri(path: '_api/client/v3/thirdparty/location', queryParameters: {
      'alias': alias,
    });
    final request = Request('GET', baseUri!.resolveUri(requestUri));
    request.headers['authorization'] = 'Bearer ${bearerToken!}';
  ...
  Future<List<Location>> queryLocationByProtocol(String protocol,
    ...
    final requestUri = Uri(
        path:
            '_api/client/v3/thirdparty/location/${Uri.encodeComponent(protocol)}',
        queryParameters: {
  ...
  ///
  /// [userid] The SDN User ID to look up.
  Future<List<ThirdPartyUser>> queryUserByID(String userid) async {
    final requestUri =
        Uri(path: '_api/client/v3/thirdparty/user', queryParameters: {
      'userid': userid,
    });
    final request = Request('GET', baseUri!.resolveUri(requestUri));
    request.headers['authorization'] = 'Bearer ${bearerToken!}';
  ...
  Future<List<ThirdPartyUser>> queryUserByProtocol(String protocol,
      {String? fields}) async {
    final requestUri = Uri(
        path: '_api/client/v3/thirdparty/user/${Uri.encodeComponent(protocol)}',
        queryParameters: {
  ...
  /// top-level `account_data` field in the node response to
  /// [/sync](#get_sdnclientv3sync).
  ///
  ...
  Future<String> defineFilter(String userId, Filter filter) async {
    final requestUri =
        Uri(path: '_api/client/v3/user/${Uri.encodeComponent(userId)}/filter');
    final request = Request('POST', baseUri!.resolveUri(requestUri));
    request.headers['authorization'] = 'Bearer ${bearerToken!}';
    request.headers['content-type'] = 'application/json';
  ...
  Future<Filter> getFilter(String userId, String filterId) async {
    final requestUri = Uri(
        path:
            '_api/client/v3/user/${Uri.encodeComponent(userId)}/filter/${Uri.encodeComponent(filterId)}');
    final request = Request('GET', baseUri!.resolveUri(requestUri));
    request.headers['authorization'] = 'Bearer ${bearerToken!}';
    final response = await httpClient.send(request);
    final responseBody = await response.stream.toBytes();
  ...
  Future<OpenIdCredentials> requestOpenIdToken(
    ...
    final requestUri = Uri(
        path:
            '_api/client/v3/user/${Uri.encodeComponent(userId)}/openid/request_token');
    final request = Request('POST', baseUri!.resolveUri(requestUri));
    request.headers['authorization'] = 'Bearer ${bearerToken!}';
    request.headers['content-type'] = 'application/json';
    request.bodyBytes = utf8.encode(jsonEncode(body));
  ...
  /// clients in the per-room entries via [/sync](#get_sdnclientv3sync).
  ///
  /// [userId] The ID of the user to set account data for. The access token must be
  /// authorized to make requests for this user ID.
  ///
  ...
  Future<Map<String, Tag>?> getRoomTags(String userId, String roomId) async {
    final requestUri = Uri(
        path:
            '_api/client/v3/user/${Uri.encodeComponent(userId)}/rooms/${Uri.encodeComponent(roomId)}/tags');
    final request = Request('GET', baseUri!.resolveUri(requestUri));
    request.headers['authorization'] = 'Bearer ${bearerToken!}';
    final response = await httpClient.send(request);
    final responseBody = await response.stream.toBytes();
  ...
  Future<void> deleteRoomTag(String userId, String roomId, String tag) async {
    final requestUri = Uri(
        path:
            '_api/client/v3/user/${Uri.encodeComponent(userId)}/rooms/${Uri.encodeComponent(roomId)}/tags/${Uri.encodeComponent(tag)}');
    final request = Request('DELETE', baseUri!.resolveUri(requestUri));
    request.headers['authorization'] = 'Bearer ${bearerToken!}';
    final response = await httpClient.send(request);
    final responseBody = await response.stream.toBytes();
  ...
  Future<TurnServerCredentials> getTurnServer() async {
    final requestUri = Uri(path: '_api/client/v3/voip/turnServer');
    final request = Request('GET', baseUri!.resolveUri(requestUri));
    request.headers['authorization'] = 'Bearer ${bearerToken!}';
    final response = await httpClient.send(request);
    final responseBody = await response.stream.toBytes();
  ...
  Future<ServerConfig> getConfig() async {
    final requestUri = Uri(path: '_api/media/v3/config');
    final request = Request('GET', baseUri!.resolveUri(requestUri));
    request.headers['authorization'] = 'Bearer ${bearerToken!}';
    final response = await httpClient.send(request);
    final responseBody = await response.stream.toBytes();
  ...
  Future<FileResponse> getContent(String serverName, String mediaId,
    ...
    final requestUri = Uri(
        path:
            '_api/media/v3/download/${Uri.encodeComponent(serverName)}/${Uri.encodeComponent(mediaId)}',
        queryParameters: {
  ...
  Future<GetUrlPreviewResponse> getUrlPreview(Uri url, {int? ts}) async {
    final requestUri = Uri(path: '_api/media/v3/preview_url', queryParameters: {
      'url': url.toString(),
  ...
  /// See the [Thumbnails](https://spec.sdn.org/unstable/client-server-api/#thumbnails) section for more information.
  ///
  /// [serverName] The server name from the `mxc://` URI (the authoritory component)
  ///
  ///
  ...
  /// larger than the size specified.
  ///
  /// [method] The desired resizing method. See the [Thumbnails](https://spec.sdn.org/unstable/client-server-api/#thumbnails)
  ...
  Future<FileResponse> getContentThumbnail(
    ...
    final requestUri = Uri(
        path:
            '_api/media/v3/thumbnail/${Uri.encodeComponent(serverName)}/${Uri.encodeComponent(mediaId)}',
        queryParameters: {
  ...
  ///
  /// returns `content_uri`:
  /// The [MXC URI](https://spec.sdn.org/unstable/client-server-api/#sdn-content-mxc-uris) to the uploaded content.
