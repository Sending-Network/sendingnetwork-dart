...
class NodeInformation {
  ...
  NodeInformation.fromJson(Map<String, Object?> json)
...
class PublicRoomsChunk {
  ...
  /// The `type` of room (from [`m.room.create`](https://spec.sdn.org/unstable/client-server-api/#mroomcreate)), if any.
  String? roomType;
...
class GetThreadRootsResponse {
  ...
  /// returned include bundled [aggregations](https://spec.sdn.org/unstable/client-server-api/#aggregations).
  ///
  /// If the thread root event was sent by an [ignored user](https://spec.sdn.org/unstable/client-server-api/#ignoring-users), the
...
class Invite3pid {
  ...
  /// (see [the list of recognised values](https://spec.sdn.org/unstable/appendices/#3pid-types)).
  String medium;
}
...
class GetKeysChangesResponse {
  ...
  /// The SDN User IDs of all users who updated their device
  /// identity keys.
  List<String>? changed;

  /// The SDN User IDs of all users who may have left all
...
class ClaimKeysResponse {
  ...
  ///
  /// See the [key algorithms](https://spec.sdn.org/unstable/client-server-api/#key-algorithms) section for information
...
@_NameSource('generated')
class SDNDIDListResponse {
  List<String> data;
  SDNDIDListResponse({required this.data});

  SDNDIDListResponse.fromJson(Map<String, dynamic> json)
      : data = List<String>.from(json['data']);

  // SDNLoginResponse.fromJson(Map<String, Object?> json)
  //     : did = json['did'] as String,
  //       message = json['message'] as String,
  //       updated = json['updated'] as String,
  //       random_server = json['random_server'] as String;
...
class SDNLoginResponse {
  ...
  Map<String, Object?> toJson() {
    ...
    final random_server = this.random_server;
    return {
      if (did != null) 'did': did,
...
class SDNDIDLoginResponse {
  ...
  SDNDIDLoginResponse.fromJson(Map<String, Object?> json)
  ...
  Map<String, Object?> toJson() {
    final access_token = this.access_token;
    final user_id = this.user_id;
    final device_id = this.device_id;
    return {
...
class Notification {
  ...
  Notification.fromJson(Map<String, Object?> json)
      : actions = (json['actions'] as List).map((v) => v as Object?).toList(),
        event = SDNEvent.fromJson(json['event'] as Map<String, Object?>),
        profileTag =
  ...
  /// See [Push Rules: API](https://spec.sdn.org/unstable/client-server-api/#push-rules-api).
  List<Object?> actions;
...
class PublicRoomQueryFilter {
  ...
  /// An optional list of [room types](https://spec.sdn.org/unstable/client-server-api/#types) to search
...
class PushCondition {
  ...
  /// The kind of condition to apply. See [conditions](https://spec.sdn.org/unstable/client-server-api/#conditions) for
...
class RegisterResponse {
  ...
  /// The fully-qualified SDN user ID (MXID) that has been registered.
  ///
...
class EventContext {
  ...
  EventContext.fromJson(Map<String, Object?> json)
      : end = ((v) => v != null ? v as String : null)(json['end']),
        event = ((v) => v != null
            ? SDNEvent.fromJson(v as Map<String, Object?>)
            : null)(json['event']),
...
class RoomEventFilter {
  ...
  /// [Lazy-loading room members](https://spec.sdn.org/unstable/client-server-api/#lazy-loading-room-members)
  ...
  /// If `true`, enables per-[thread](https://spec.sdn.org/unstable/client-server-api/#threading) notification
...
class RoomEventsCriteria {
  ...
  /// This takes a [filter](https://spec.sdn.org/unstable/client-server-api/#filtering).
  SearchFilter? filter;
...
class ResultRoomEvents {
  ...
  Map<String, List<SDNEvent>>? state;
}
...
class ThirdPartyUser {
  ...
  /// A SDN User ID represting a third party user.
  String userid;
}
...
class OpenIdCredentials {
  ...
  OpenIdCredentials.fromJson(Map<String, Object?> json)
      : accessToken = json['access_token'] as String,
        ...
        sdnServerName = json['sdn_server_name'] as String,
        tokenType = json['token_type'] as String;
  Map<String, Object?> toJson() => {
        'access_token': accessToken,
        'expires_in': expiresIn,
        'sdn_server_name': sdnServerName,
...
class GetUrlPreviewResponse {
  ...
  Map<String, Object?> toJson() {
    final sdnImageSize = this.sdnImageSize;
    final ogImage = this.ogImage;
    return {
      if (sdnImageSize != null) 'sdn:image:size': sdnImageSize,
  ...
  /// An [MXC URI](https://spec.sdn.org/unstable/client-server-api/#sdn-content-mxc-uris) to the image. Omitted if there is no image.
  Uri? ogImage;
}
